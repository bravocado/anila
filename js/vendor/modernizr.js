 ...
 * Build: http://modernizr.com/download/#-fontface-borderradius-boxshadow-opacity-rgba-textshadow-generatedcontent-cssgradients-csstransforms-csstransitions-audio-video-touch-shiv-mq-cssclasses-teststyles-testprop-testallprops-prefixes-domprefixes-load-cssclassprefix:md
 */
;
window.Modernizr = function (a, b, c) {
    ...
    return e.addTest = function (a, b) {
        if (typeof a == "object")
            ...
            a = a.toLowerCase();
            if (e[a] !== c) return e;
            b = typeof b == "function" ? b() : b, typeof f != "undefined" && f && (g.className += " md" + (b ? "" : "no-") + a), e[a] = b
        }
        return e
    }, B(""), i = k = null,
    function (a, b) {
        ...
        return F([a])
    }, e.testAllProps = H, e.testStyles = x, g.className = g.className.replace(/(^|\s)no-js(\s|$)/, "$1$2") + (f ? " mdjs md" + u.join(" md") : ""), e
}(this, this.document),
function (a, b, c) {
    function d(a) {
